...
// Project: https://github.com/leemind/cordova-plugin-push
...
declare namespace PhonegapPluginPush {
	...
	interface InitOptions {
		...
		ios?: {
			 ...
			 * Action Buttons on iOS - https://github.com/leemind/cordova-plugin-push/blob/master/docs/PAYLOAD.md#action-buttons-1
			 */
